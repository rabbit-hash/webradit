  ...
  return (
    <div className="max-w-4xl mx-auto px-6 lg:px-8 py-20 lg:py-32">
      ...
      <section id="about" className="mb-24 scroll-mt-24 relative">
        {/* Lanyard Animation - Fixed next to Sidebar to prevent being cut off by it */}
        <div className="hidden xl:block fixed left-[288px] top-0 w-[500px] h-screen shrink-0 z-0 pointer-events-none">
